...
// Empty/null is always valid -- a secondary category is optional. When
// present, it must be a real category and must not equal the primary one:
// one room always stays prominent.
export function validSecondaryCategory(primary, value) {
  if (!value) return true;
  return validCategory(value) && value !== primary;
}
