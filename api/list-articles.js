...
export default async function handler(req, res) {
  ...
  try {
    const { data, error } = await getSupabase()
      .from("fsa_articles")
      .select("id,category,seed,angle,status,issue,brief,final_decision,final_notes,draft_round,image_round,image_url,image_brief,draft_meta,created_at,updated_at")
